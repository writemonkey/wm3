module.exports = function(api, pluginInfo) {
	...
	function getImages(q, callback) {
		...
		var url = 'https://www.google.si/search?q=' + q + '&hl=en&oq=images&site=webhp&source=lnt&tbm=isch&tbas=0&biw=1280&bih=576&dpr=2&tbs=itp:photo' + (options.hiResImagesOnly ? ',islt:svga,isz:l' : '');
